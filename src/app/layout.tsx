  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="edu-roldan-fisioterapia";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Edu Roldán Fisioterapia"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="edu-roldan-fisioterapia"
      ...
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="edu-roldan-fisioterapia";
